...
import com.sandino.concurrent.callable.ConcurrentCallableKnn;
...
public class ConcurrentCallableJMeterTest extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        ConcurrentCallableKnn concurrentCallableKnn = new ConcurrentCallableKnn(filename,
        ...
        try {
            double prediction = concurrentCallableKnn.predictClassification(initialRow, Integer.valueOf(k));
