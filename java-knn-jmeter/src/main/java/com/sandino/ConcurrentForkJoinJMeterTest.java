...
import com.sandino.concurrent.forkjoin.ConcurrentForkJoinKnn;
...
public class ConcurrentForkJoinJMeterTest extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        ConcurrentForkJoinKnn concurrentForkJoinKnn = new ConcurrentForkJoinKnn(filename,
        ...
        try {
            double prediction = concurrentForkJoinKnn.predictClassification(initialRow, Integer.valueOf(k));
