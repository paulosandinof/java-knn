...
public class ConcurrentParallelStreamJMeterTest extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        ConcurrentParallelStreamKnn concurrentParallelStreamKnn = new ConcurrentParallelStreamKnn(filename,
        ...
        try {
            double prediction = concurrentParallelStreamKnn.predictClassification(initialRow, Integer.valueOf(k));
